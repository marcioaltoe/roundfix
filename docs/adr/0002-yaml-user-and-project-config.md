...
An untracked or modified Project Config does not block `fetch`, `resolve`, or `watch`. Batch commits exclude Project Config changes so local setup does not silently mix with review fixes.
