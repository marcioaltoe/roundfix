...
- Decision: `VALID`
- Notes: Fixed profile configure and validate JSON success paths to return encoder errors and map them to `exitRunFailed`, with failing-writer tests. Evidence: `GOCACHE=/private/tmp/roundfix-go-build rtk go test ./internal/agent ./internal/cli ./internal/config ./internal/daemon ./internal/releaseplan ./internal/spec ./internal/store ./internal/tui` passed.
