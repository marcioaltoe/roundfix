...
- Decision: `VALID`
- Notes: Fixed release classification to apply the maintenance-only boundary before aggregating automatic impact, with `fix:` and `feat!:` maintenance-only regressions. Evidence: `GOCACHE=/private/tmp/roundfix-go-build rtk go test ./internal/agent ./internal/cli ./internal/config ./internal/daemon ./internal/releaseplan ./internal/spec ./internal/store ./internal/tui` passed.
