...
|---|---|---|
| 1 | **Cortada** — marginal ou desnecessária | 1.97 |
| 2 | Entrega 7 — medição mínima | 2.13 |
| 3 | Entrega 7 — medição mínima | 2.1 |
| 4 | **Cortada** — marginal ou desnecessária | 0.79 |
| 5 | Entregue por slice anterior | — |
| 6 | Entrega 7 — medição mínima | 2.38 |
