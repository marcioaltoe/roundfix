...
Residual ownership by section: §2/§4/§5/§9→0126; present-target squash in §6→0125; authoring guardrails in §8→0129. Independent native review is required; obsolete CodeRabbit mechanics are retired only by their implemented replacement.
