...
- Decision: `VALID`
- Notes: Fixed profile fragment and config merge decoding to reject additional YAML documents before parsing or rewriting, with no-mutation regression coverage. Evidence: `GOCACHE=/private/tmp/roundfix-go-build rtk go test ./internal/agent ./internal/cli ./internal/config ./internal/daemon ./internal/releaseplan ./internal/spec ./internal/store ./internal/tui` passed.
