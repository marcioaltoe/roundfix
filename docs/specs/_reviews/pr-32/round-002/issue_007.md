...
- Decision: `VALID`
- Notes: Fixed Agent Session close failures to propagate through `agentSessionOwner.Close` and review batch cleanup, with regression coverage for Batch close failure reporting. Evidence: `GOCACHE=/private/tmp/roundfix-go-build rtk go test ./internal/agent ./internal/cli ./internal/config ./internal/daemon ./internal/releaseplan ./internal/spec ./internal/store ./internal/tui` passed.
