...
status: failed
terminal_reason: "The finding is valid, but all four target files are unassigned prior-round Review Issue artifacts that this Batch is forbidden to edit."
...
review_hash: 4d8de88555665aecdd7de3ec3d1461ea810bb478631eed53be0368a167e58b01
duplicate_of: ""
...
- Decision: `VALID`
- Notes: Direct inspection confirms Round 002 issues 006 through 009 still
  use spaced emphasis in their headings and bare prompt fences. The requested
...
- Focused evidence: the bounded `rtk rg` inspection over Round 002 issues 006
  through 009 reported the malformed headings and bare fences. The command
