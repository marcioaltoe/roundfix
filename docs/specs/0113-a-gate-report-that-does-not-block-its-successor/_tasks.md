...
graph:
  nodes:
    ...
    - id: task_07
      file: task_07.md
      needs: [task_02, task_04, task_06, task_08, task_09, task_10]
---
...
| task_10 | Give the gate's classification a boundary the code can see   | backend | medium     | task_09                   |
| task_07 | Run the final QA gate                                        | qa      | high       | task_02, task_04, task_06, task_08, task_09, task_10 |
