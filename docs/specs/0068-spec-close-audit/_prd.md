...
- Active ADR obligations: applicable — ADR-0052 protects terminal completion,
  ...
  ADR-0081 sanctions the deterministic digest fallout of the authorized Skill
  synchronisation. ADR-0080 owns QA verdict semantics and
  ...
  Consistency Check's detection boundary, a different subsystem from Run
  reconciliation. Source: `docs/agents/domain.md`.
