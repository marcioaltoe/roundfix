...
one family: **the Spec assumes the world behaves like its fakes.** [Spec 0091](../../../history/specs/0091-a-proof-that-can-refuse/)
...
- F-001: the PRD promised Roundfix's membership verdict would own the refusal.
  ...
  execution does not support, now recorded in [ADR-0119](../../../history/adr/0119-the-refusal-that-fired-first-is-the-refusal.md).
...
does. On [0091](../../../history/specs/0091-a-proof-that-can-refuse/) that single change would have surfaced F-001 on day one instead
