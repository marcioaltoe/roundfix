...
archived: "2026-08-05"
source_slug: 0066-run-teardown-reclaims-what-it-created
---
...
- Active ADR obligations: applicable — ADR-0052 protects terminal completion,
  ...
  Branches. ADR-0081 sanctions the deterministic digest fallout of the
  authorized Skill synchronisation. ADR-0080 owns QA verdict semantics and
  ADR-0091 owns the authored QA gate as a typed Task node, under which this
  Spec's own graph is authored. ADR-0093 surfaces as a relation candidate
  because it cites ADR-0080; it does not apply — it governs the Spec
  Consistency Check's detection boundary. Source: `docs/agents/domain.md`.
