...
| 4 | `0073-skill-minimum-version-contract` | Authored on PR #80. Decouples skill versions from the Roundfix version behind a per-skill declared minimum; blocks the 0.3.1 release cut that follows it. |
