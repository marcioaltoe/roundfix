...
Rows 1 through 6 are authored and executable: every one has a task graph, and
`roundfix spec check` reports no findings on any of them. Numbers 7 through 9 are
