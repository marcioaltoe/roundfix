...
- TypeScript rules are mandatory: `docs/agents/typescript-bun.md`.
...
- Bun runtime rules are mandatory: `docs/agents/typescript-bun.md`.
...
- Before cross-package work, follow `docs/agents/monorepo.md`.
...
- Backend boundary rules are mandatory: `docs/agents/backend.md`.
...
- Frontend behavior and design-contract rules are mandatory: `docs/agents/frontend.md`.
...
- Follow the mandatory setup-owned baseline in `docs/agents/agent-instructions.md`.
...
- Read `docs/agents/repository.md` for project-specific hard rules.

<!-- setup-context-driven:end id=root.repository-extension -->
