...
// Spec directory. Report names embed the date as YYYY-MM-DD, so the
// lexicographically greatest path is the newest report. Missing reports
// surface as ErrNoQAReport.
