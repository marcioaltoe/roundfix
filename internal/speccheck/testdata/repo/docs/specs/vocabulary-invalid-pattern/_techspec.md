# Vocabulary invalid pattern fixture TechSpec
...
- emits: `docs/specs/vocabulary-invalid-pattern/emitter.go`
  pattern: `[`
  documented-in: `docs/specs/vocabulary-invalid-pattern/runbook.md`
